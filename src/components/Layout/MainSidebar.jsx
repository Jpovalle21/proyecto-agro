...
export default function MainSidebar() {
  ...
  return (
    <aside className="hidden md:flex w-64 h-screen flex-col justify-between bg-[#1f2937] text-white shadow-xl shrink-0">
      ...
      <div className="px-5 pb-6">
        <button
          ...
          className="w-full py-2.5 rounded-lg text-sm bg-white/10 hover:bg-white/20 transition"
        >
          Panel principal
        </button>
      </div>
