...
export default function MantenimientoSidebar() {
  const navigate = useNavigate();

  const menu = [
    { name: "Solicitudes", path: "/app/mantenimiento/solicitudes-mantenimiento" },
    { name: "Historial", path: "/app/mantenimiento/historial-mantenimiento" },
    { name: "Maquinarias", path: "/app/mantenimiento/maquinarias" },
   
  ];

  return (
    <div className="w-64 h-screen flex flex-col justify-between bg-gradient-to-b from-[rgb(183,183,183)] to-[rgb(0,9,14)] text-white shadow-2xl">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `px-4 py-3 rounded-lg text-sm transition-all duration-300 ${
                  isActive
                    ? "bg-white/90 text-[rgb(183,183,183)] font-medium shadow-md"
